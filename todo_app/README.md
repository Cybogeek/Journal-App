...
### Todo (local Notification /Reminder)

#### V: 2 (Updated)

New Set Reminder feature is added, It will allow users to set the notification reminder for the Task to complete.

### Packages added:

- _flutter local notification_- used to show local notification. (Curently tested for Android only)

### Future Updates:

- _FCM integration_- Firebase messagiung will be used for server side notification management.
